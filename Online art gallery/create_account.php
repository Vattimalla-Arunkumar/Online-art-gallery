...
<style>
  ...
  body {
                ...
                height: 100%;
                width: 100%;
                background: url(pictures/nani.jpg) no-repeat fixed;
...
<div class="border">
      ...
      <form action = "create_account.php"enctype="multipart/form-data" method="POST">
           ...
           <p class="fsize-text"> Username: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" required name="username" ><br><br>
            ...
            Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="password" required name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" ></p>
